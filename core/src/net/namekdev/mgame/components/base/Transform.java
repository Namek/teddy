...
public class Transform extends PooledComponent {
	...
	public Transform xyz(DVector3C pos) {
		return xyz((float)pos.get0(), (float)pos.get1(), (float)pos.get2());
	}
	...
	public Transform direction(DVector3C pos) {
		return direction((float)pos.get0(), (float)pos.get1(), (float)pos.get2());
	}
