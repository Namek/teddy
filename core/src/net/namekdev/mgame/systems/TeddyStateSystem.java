...
import static net.namekdev.mgame.components.Teddy.DOWN;
...
import static net.namekdev.mgame.components.Teddy.UP;
...
public class TeddyStateSystem extends EntitySystem {
	...
	protected void processSystem() {
		...
		boolean canRun = state.carriedEntityId == -1 && Gdx.input.isKeyPressed(Keys.SHIFT_LEFT);
